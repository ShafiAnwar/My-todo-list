...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Admin\Desktop\Coding\My own Practice\new_solidity\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Admin\Desktop\Coding\My own Practice\new_solidity\env\Scripts\deactivate.nu'
